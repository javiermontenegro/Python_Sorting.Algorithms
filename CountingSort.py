...
# Copyright:
# Details:   This code is the implementation of the counting sort algorithm.
#*********************************************************************
...
if __name__ == "__main__": 
    ...
    print("List positive numbers: %s\n" % repr(positive_array))

    negative_array = [-5, -6, -2, -3, -4, -5, 0, -9, -2, -3, -8, -4]
    print("List negative numbers: %s\n" % repr(negative_array))

    x = counting_sort(positive_array)
    print("Ordered list: %s" % x)

    y = counting_sort(negative_array)
    print("Ordered list: %s" % y) 